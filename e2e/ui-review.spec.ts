...
const ROOMS: MockRoom[] = [
  ...
  mk("มั่งมี", "1", "104", "รอสัญญา", { tenant: "คุณจองไว้ รอเซ็น", phone: "0801112222", note: "โอนมัดจำแล้ว ขอเข้าช่วงเย็น" }),
  ...
  mk("กลางเมือง", "1", "103", "รอสัญญา", { tenant: "คุณใหม่ เพิ่งจอง", note: "รอเซ็นสัญญา ยังไม่ได้นัดวันเข้า" }),
